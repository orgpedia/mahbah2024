# Orders of deparment of Other Backward Bahujan Welfare Department Government of Maharashtra
...
1. [mahbah2024-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahbah2024-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
```
git clone https://github.com/orgpedia/mahbah2024.git
```
